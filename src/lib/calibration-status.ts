...
// Bloc R — `calibrationConfidenceFor`/`exercisesEverDone` (cas spécial des exos
// `e1RM_app:'non'`) supprimés : le modèle de mesure est unifié, tous les exos
// passent désormais par les snapshots datés (`e1rmConfidenceFor`).
